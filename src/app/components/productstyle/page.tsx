...
export default function HappyClient() {
    return (
        <section className="md:w-[1239px] mx-8  md:h-[866px] bg-[#F2F0F1] w-[358px] h-[975px] md:bg-sl rounded-3xl">
  ...
  ">
            ...
            <div className="gap-4 md:grid-cols-2 p-4 justify-center md:space-y-4 space-y-2">
